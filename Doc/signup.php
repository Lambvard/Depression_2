        ...
        <div class="col-md-6 mx-auto" style=";">
          <div class="detail-box">
            <div class="">
              ...
              <div class="mt-3">
                <input type="text" name="" class="form-control" placeholder="Othernames">
              </div>
              <div class="mt-3">
              ...
              <div class="mt-3">
                <input type="password" name="" class="form-control" placeholder="Enter a password">
              </div>

              <div class="mt-3 float-end" style="font-size: 13px; font-weight:bold;">
                <button class="btn btn-danger float-end">Register</button><p>
